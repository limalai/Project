...
CREATE TABLE `work` (
  ...
  CONSTRAINT `FK_Subject` FOREIGN KEY (`Subject`) REFERENCES `subject` (`subjectID`),
...
INSERT INTO `work` VALUES (2,'software project','2023-10-11',202,2,103),(52,'software project','2023-10-11',202,2,103);
